      ...
      <Card>
        ...
        <CardContent>
          ...
          <div>
            <p>
              {" "}
              3. Something that serves as a pattern of behaviour to be imitated
              (a good example) or not to be imitated (a bad example).
            </p>
          </div>
          <div>
          ...
          <div>
            <p>
              {" "}
              5. A parallel or closely similar case, especially when serving as
              a precedent or model.
            </p>
          </div>
          <div>
            <p>
              ...
              the rule or precept or to act as an exercise in the application of
              the rule.
            </p>
          </div>
        </CardContent>
